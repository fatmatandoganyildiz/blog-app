  ...
  return (
    <div class="container mx-auto mb-14">
      ...
      <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
        ...
        believe that a strong, diverse, and passionate team is the driving force
        behind our success. Get to know the individuals who bring creativity,
        expertise, and dedication to everything we do.
      </p>
