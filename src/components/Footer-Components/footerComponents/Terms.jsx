          ...
          <div className="max-w-screen-lg bg-gray-100 p-8 rounded-lg shadow-md">
            <div className="space-y-8">
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="flex justify-between items-center text-lg font-semibold focus:outline-none hover:text-[#aa2312]">
                  ...
                  <>
                    ...
                    <Disclosure.Panel className="text-gray-700">
                      ...
                      <p>
                        ...
                        various purposes aimed at improving and personalizing
